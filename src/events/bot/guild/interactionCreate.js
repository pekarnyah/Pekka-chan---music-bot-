const { ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, InteractionType, ModalBuilder, TextInputBuilder, TextInputStyle } = require("discord.js");
...
module.exports = async (client, interaction) => {
    ...
    console.log(`[INTERACTION] Type: ${interaction.type}, CustomId: ${interaction.customId || "N/A"}, Acknowledged: ${interaction.deferred || interaction.replied}`);

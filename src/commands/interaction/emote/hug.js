...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        console.log(`[DEBUG] Processing /hug by ${user.tag} (${user.id})`);
        ...
        if (!member) {
            ...
            embed.setDescription(`${user} hug ${member}`);
            const res = await fetch("https://api.waifu.pics/sfw/hug").then((r) => r.json());

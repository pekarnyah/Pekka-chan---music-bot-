...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        console.log(`[DEBUG] Processing /kill by ${user.tag} (${user.id})`);
        ...
        if (!member) {
            ...
            embed.setDescription(`${user} kill ${member}`);
            const res = await fetch("https://api.waifu.pics/sfw/kill").then((r) => r.json());

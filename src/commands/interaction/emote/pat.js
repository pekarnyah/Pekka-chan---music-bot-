...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        console.log(`[DEBUG] Processing /pat by ${user.tag} (${user.id})`);
        ...
        if (!member) {
            ...
            embed.setDescription(`${user} pat ${member}`);
            const res = await fetch("https://api.waifu.pics/sfw/pat").then((r) => r.json());
